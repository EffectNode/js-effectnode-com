...
export class Curves {
  constructor ({ ctx, runEditor = true }) {
    ...
    let controlPoints = [
      new THREE.Vector3(-478.84976227459873, 148.40563818999576, 359.5844513244794),
      new THREE.Vector3(-467.0932304744955, 148.40563818999576, 46.48514282191866),
      new THREE.Vector3(-14.959734606523284, 138.59061351673523, -346.2827138747857),
      new THREE.Vector3(300.8575168842313, 102.66487050746449, 190.6376563597828),
      ...
      new THREE.Vector3(-96.45097508642567, -120.16801322370745, 348.18305349716536),
      new THREE.Vector3(241.84208537109504, -118.98657965633289, 49.30659786766293)
    ]
